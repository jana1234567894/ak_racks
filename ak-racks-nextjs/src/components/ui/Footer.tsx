                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a
                                ...
                                className="w-10 h-10 bg-slate-800 hover:bg-orange-600 rounded-lg flex items-center justify-center transition-colors"
                            >
                    ...
                    <div>
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <div className="w-10 h-10 bg-slate-800 group-hover:bg-orange-600 rounded-lg flex items-center justify-center transition-colors flex-shrink-0">
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-sm">
                        {siteConfig.services.map((service, index) => (
                            <span key={service} className="flex items-center gap-2 text-slate-400">
                                <span className="w-2 h-2 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full" />
                                {service}
                                {index < siteConfig.services.length - 1 && (
                                    <span className="hidden md:inline text-slate-600 ml-4">|</span>
                                )}
                            </span>
                        ))}
                    </div>
            ...
            <div className="border-t border-slate-800 bg-slate-950">
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-slate-500">
                        <p>© {new Date().getFullYear()} AK Racks. All rights reserved.</p>
